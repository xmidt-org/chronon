...
1. Search and replace chronon with your project name.
1. Initialize `go.mod` file: `go mod init github.com/xmidt-org/chronon`
...
1. For libraries:
    ...
    1. Remove the following files/dirs: `.dockerignore`, `Dockerfile`, `Makefile`, `rpkg.macros`, `chronon.yaml`, `deploy/`, and `conf/`.
1. For applications:
    ...
    1. Update `deploy/packaging/chronon.spec` file to have a proper Summary and Description.
    1. Update `conf/chronon.service` file to have a proper Description.
